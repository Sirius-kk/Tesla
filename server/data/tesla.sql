...
(NULL,"sirius","E6E407B1EDB2CCA3DEF82992C8EF32D9","18022229523@163.com",18020029511,"Sirius-kk",NULL,1);
/* **********************插入一条用户数据**************** */
...
INSERT INTO ts_part_product VALUES
  ...
  NULL,
  NULL,
  '<p>采用厚实耐用的绒面材质，柔软舒适，经过防污渍处理，易于清洁。由 Tesla Design Studio 原厂设计。</p> <p><em>注意：这款脚垫套装包含在「
		Model 3 高级版内饰套件」中，已选配该套件的车型无需单独购买</em></p>',
  '1103250-00-D_0.jpg',
  '1103250-00-D_3.jpg',
  '1103250-00-D_0.jpg1103250-00-D_1.jpg1103250-00-D_2.jpg1103250-00-D_4.jpg',3),
  /* Model 3  类型编号: 2  内饰 */
  (NULL,
  2,
  '内饰',
  ...
  NULL,
  NULL,
  '<p>由轻质网状织物和可折叠的高锰钢框架组成，可阻挡三分之二的太阳能热负荷。安装于车顶天窗内部，拆卸简便。不使用时可折叠存放在配套收纳袋中。自行安装即可，无需到店。如果安装时遇到问题请联系客户支持。</p>
	<p> 包含： </p> 
  <ul> <li>2 个鹰翼门车顶遮阳帘</li> <li>1 个拉链式收纳袋</li> </ul>',
  '1078357-00-A_0.jpg',
  '1078357-00-A_alt.jpg',
  '1078357-00-A_0.jpg1078357-00-A_1.jpg1078357-00-A_alt.jpg',3),
  /* Model X  类型编号: 3   内饰 */
  (NULL,
  3,
  '内饰',
  ...
  NULL,
  NULL,
  '<p>Model X 置物网，为您放置在后备箱的物品提供有效防护，便利实用。</p>
  <p>置物网富有弹性，易于安装，完美适配六座和七座版车型，可轻松保护易碎品，或运动器材及行李箱等。 </p>
  <p>内含一个储物袋，方便您在家里或车中存放。</p>',
  '1521206-00-A_0.jpg',
  '1521206-00-A_1.jpg',
  '1521206-00-A_0.jpg1521206-00-A_1.jpg1521206-00-A_2.jpg1521206-00-A_3.jpg',3),
  /* Model X  类型编号: 3   外观 */
  (NULL,
  3,
  '外观',
  ...
  '<h3>室内车衣</h3> <p>弹力缎面，像手套一样贴合车身，可有效防止漆面刮擦或尘埃积聚。充电端口处有专门的开口，可正常连接充电器。通风网孔在充电时有利于车辆散热。</p>
	...
	<ul> <li>1 个车衣</li> <li>1 个收纳袋</li> </ul> ',
  '1069533-01-A_0.jpg',
  '1069533-01-A_alt.jpg',
  '1069533-00-A_0.jpg1069533-00-A_alt.jpg',3),
  /* Model X  类型编号: 3   轮毂和轮胎 */
  (NULL,
  3,
  '轮毂和轮胎',
  '轮胎修理密封胶',
  ...
  NULL,
  NULL,
  '<p>这款密封胶专用于 <a href="https://shop.tesla.cn/product/tire-repair-kit">Tesla 轮胎修理工具包</a>，当轮胎修理工具包附带的密封胶用完或达到有效期时作为替换装使用。</p>',
  '1107992-00-A_0.jpg',
  '1107992-00-A_0.jpg',
  '1107992-00-A_0.jpg',3),
  /* Model X  类型编号: 3   脚垫 */
  (NULL,
  3,
  '脚垫',
  ...
  NULL,
  NULL,
  '<p>采用厚实耐用的绒面材质，柔软舒适，经过防污渍处理，易于清洁。</p><p></p>适用于 Model X 前排座舱。<p></p>',
  '1103024-00-A_0.jpg',
  '1103024-00-A_alt.jpg',
  '1103025-00-Aa1.jpg1103026-01-B_0.jpg1468511-00-A_0.jpg1103027-00-A_0.jpg',3);
/* 还有好多........ */
...
/* 女装  类型编号: 2  T恤 */
  ...
  2,
  'T恤',
  '女装 Made on Earth by Humans 短袖T恤',
  249,
  NULL,
  '#808080;#04010a;#ffffff;',
  'S;M;L;XL;',
  ...
  '1478257-02-A_0.jpg',
  '1478257-00-A_1.jpg',
  '1478257-02-A_0.jpg1478257-00-A_1.jpg',4
  ), 
  /* 女装  类型编号: 2  帽子 */
  (NULL,
  2,
  ...
  '#04010a;#ffffff;#dd0000;',
  NULL,
  '<p>经典棒球帽款式，帽身挺括，帽檐弧形下弯，饰有 Tesla 字母 Logo。100% 纯棉制造。有黑色、红色和白色三种颜色可选。</p>',
  '1462059-00-A_0.jpg',
  '1462059-00-A_2.jpg',
  '1462059-00-A_0.jpg1462059-00-A_1.jpg1462059-00-A_2.jpg',4),
  /* 童装  类型编号: 3  上衣 */
  (NULL,
  3,
  '上衣',
  ...
  '#808080;#04010a;#ffffff;',
  'S;M;L;XL;',
  '<p>由 100% 纯棉制成，质地柔软，触感舒适。</p>
  <ul>
  <li>2T(110/56) : 衣长45.0cm，肩宽 29.5cm</li>
  <li>4T(120/60) : 衣长48.0cm，肩宽 31.0cm</li>
  <li>6 (130/64) : 衣长51.0cm，肩宽 32.5cm</li>
  <li>8 (140/68) : 衣长55.0cm，肩宽 34.0cm</li>
  <li>10 (150/72) : 衣长59.0cm，肩宽 35.5cm</li>
  <li>12 (160/76) : 衣长63.0cm，肩宽 37.5cm</li>
  </ul>',
  '100042307_0.jpg',
  '100042307_1.jpg',
  '100042307_0.jpg100042307_1.jpg100042307_alt.jpg',4
  ), 
  /* 童装  类型编号: 3  帽子 */
  (NULL,
  3,
  ...
  '#04010a;#ffffff;#dd0000;',
  NULL,
  '<p>由 15％ 羊毛和 85％ 腈纶制成。配有可调节的卡扣，可满足大多数佩戴需求。</p>',
  '1462064-00-A_0.jpg',
  '1462064-00-A_2.jpg',
  '1462064-00-A_0.jpg1462064-00-A_1.jpg',4);
/* 还有呢 */
/* ***************************************************** */
/* *******************周边精品详情数据表****************** */
